...
**NOTICE**: Around Oct. 10th, 2023 there was a major update to use consult-async. This required re-implementing the package from scratch and may break old version. In the new version, there are many new features and functionalities including:
