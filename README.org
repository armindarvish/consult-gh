...
If you use [[https://github.com/blahgeek/emacs-pr-review][emacs-pr-review]] for reviewing pull requests, you can use =consult-gh-with-pr-review= to directly open issues in a pr-review buffer and do your review in =pr-review=. To do so enable =consult-gh-with-pr-review-mode=:
#+begin_src emacs-lisp
