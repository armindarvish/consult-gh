...
- [[id:F9B00342-3608-4115-8AEF-B22C588F6AB0][About consult-gh]]
- [[id:C36967B4-EB5D-41E4-9E38-28CA7465DD7B][Getting Started]]
- [[id:0AAC346E-481A-48AB-B7DA-1569EBA4A145][Features and Demos (Usage)]]
- [[id:4F1D82C1-7FCE-4377-8F8C-772BC3F8A9BD][Bug reports]]
- [[id:6135E51E-AC57-45E1-984F-D591B0FFB899][Contributions]]
- [[id:2DE59C1D-2760-40F0-940D-FBCF7750E52D][Comparison with Other Packages]]
- [[id:C2A4FCAC-A902-4254-AB1A-6FFAE91D4023][Acknowledgments]]

* About consult-gh
:PROPERTIES:
:ID:       F9B00342-3608-4115-8AEF-B22C588F6AB0
:END:
...
* Getting Started
:PROPERTIES:
:ID:       C36967B4-EB5D-41E4-9E38-28CA7465DD7B
:END:
...
Whether consult-gh-forge should ask for confirmation when chosing the account for authorization.  If this is set to =nil=, consult-gh uses the =gh= setting to get the account name and token for authorization. Otherwise, it compares the setting from =gh= with that of forge settings (e.g. the credentials stored in authinfo), and when they are different, queries the user to pick which account should be used.

** PR-Review Integration

If you use [[https://github.com/blahgeek/emacs-pr-review][emacs-pr-review (pr-review package on MELPA)]] for reviewing pull requests, you can use =consult-gh-with-pr-review= to directly open issues in a pr-review buffer. To do so,  enable =consult-gh-with-pr-review-mode= by running =M-x consult-gh-with-pt-review-mode= or putting the following in your init file:
#+begin_src emacs-lisp
...
Whether consult-gh-with-pr-review should ask for confirmation when chosing the account for authorization.  If this is set to =nil=, consult-gh uses the =gh= setting to get the account name and token for authorization. Otherwise, it compares the setting from =gh= with that of pr-review settings (e.g. the credentials stored in authinfo), and when they are different, queries the user to pick which account should be used.
...
* Bug reports
:PROPERTIES:
:ID:       4F1D82C1-7FCE-4377-8F8C-772BC3F8A9BD
:END:
...
* Contributions
:PROPERTIES:
:ID:       6135E51E-AC57-45E1-984F-D591B0FFB899
:END:
...
:PROPERTIES:
:ID:       2DE59C1D-2760-40F0-940D-FBCF7750E52D
:END:
...
* Acknowledgments
:PROPERTIES:
:ID:       C2A4FCAC-A902-4254-AB1A-6FFAE91D4023
:END:
