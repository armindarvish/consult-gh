...
(defun consult-gh--get-current-orgs ()
  "Gets the organizations for currently logged in user by running `gh api user/orgs` and returning the login field."
 (gethash :login (car (consult-gh--api-json-to-hashtable (cadr (consult-gh--api-get-json "user/orgs"))))))

(defun consult-gh--get-gitignore-template-list ()
"Lists name of .gitignore templates"
(string-split (string-trim (cadr (consult-gh--api-get-json "gitignore/templates")) "\\[" "\\]") "," t "\""))
...
(mapcar (lambda (item) (cons (gethash :name item) (gethash :key item))) (consult-gh--api-json-to-hashtable (cadr (consult-gh--api-get-json "licenses")))))
...
(delq nil (mapcar (lambda (item) (when (eq (gethash :is_template item) t) (gethash :full_name item))) (consult-gh--api-json-to-hashtable (cadr (consult-gh--api-get-json endpoint)))))))
